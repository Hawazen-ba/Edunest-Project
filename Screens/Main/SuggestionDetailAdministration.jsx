...
const SUBCATEGORIES = [
  ...
  "Scolarity Services",
  "Internship Services",
  "Accueil and Information Services",
];

const SuggestionDetailAdministration = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.background }}>
      <GeneralHeader title={"Administration Suggestion"} showBackArrow={true} />
...
export default SuggestionDetailAdministration;
