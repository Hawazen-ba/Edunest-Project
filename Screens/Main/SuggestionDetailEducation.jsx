...
const SUBCATEGORIES = ["Teaching Quality", "Curriculum", "Exams", "Other"];

const SuggestionDetailEducation = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.background }}>
      <GeneralHeader title={"Education Suggestion"} showBackArrow={true} />
...
export default SuggestionDetailEducation;
