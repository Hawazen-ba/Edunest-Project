...
const SchoolSelector = ({ data, selectedValue, onSelect }) => {
  const [isOpen, setIsOpen] = useState(false);
  const Colors = useColors();

  const selectedSchool = data.find((school) => school.id === selectedValue);
  const selectedName = selectedSchool ? selectedSchool.name : "Select a School";
